...
<!-- Light background container for better icon visibility -->
<div align="left" style="background-color: #f4f4f4; padding: 15px; border-radius: 10px; display: flex; flex-wrap: wrap; gap: 10px;">
